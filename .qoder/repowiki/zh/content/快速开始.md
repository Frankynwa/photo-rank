...
## 简介
本快速开始指南帮助你在最短时间内完成环境准备、安装依赖、配置环境变量并启动服务，随后通过一次完整的照片评分流程体验系统核心能力。系统基于 FastAPI 提供 Web UI，支持拖拽上传、实时进度推送与结果查看；后端流水线包含客观指标、相似聚类、审美评分、人脸质量与深度分析等多层处理，并支持视频抽帧与视频精选榜。
